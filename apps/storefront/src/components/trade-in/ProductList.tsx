...
import FacetList from "../product/facets/FacetList";
import ProductCard from "../trade-in/ProductCard";

export interface ProductListProps {
  renderItem?: (product: BuyerProduct) => JSX.Element;
}

const TradeInProductList: FunctionComponent<ProductListProps> = ({ renderItem }) => {
